...
export const TABLE_DESCRIPTIONS = {
	...
	'CFF ': 'Contains PostScript-flavored (Type 2) cubic Bézier glyph outlines for CFF-based OpenType fonts.',
	...
	'cvt ': 'Stores TrueType control values used by glyph hinting instructions to ensure consistent rendering.',
	...
	'OS/2': 'Stores OS/2 and Windows-specific metrics - weight class, width class, Unicode ranges, and embedding flags.',
	...
	'SVG ': 'Contains SVG documents that define glyph appearances as scalable vector graphics.',
