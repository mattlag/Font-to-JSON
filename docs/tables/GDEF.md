...
- `itemVariationStore` - structured ItemVariationStore (parsed via shared parser)
...
```json
{
		...
		"ligGlyphs": [
			[
				...
				{ "format": 2, "caretValuePointIndex": 7 },
				{
					"format": 3,
					"coordinate": 400,
					"device": { "format": 1, "deltaFormat": 2, "deltaValues": [0] }
				}
			]
		]
	},
	"markAttachClassDef": {
		"format": 2,
		"classRangeRecords": [{ "start": 100, "end": 120, "class": 1 }]
	},
	"markGlyphSetsDef": {
		"format": 1,
		"coverages": [{ "format": 1, "glyphArray": [200, 201] }]
	},
...
- `itemVariationStore` is a fully parsed ItemVariationStore matching the format used by HVAR/VVAR/MVAR/COLR.
...
- `minorVersion >= 3` enables `itemVarStoreOffset` / `itemVariationStore`.
